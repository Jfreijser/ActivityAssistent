...
/// <summary>
/// Reason for the status of the newprocess.
/// </summary>
[System.Runtime.Serialization.DataContractAttribute()]
[System.CodeDom.Compiler.GeneratedCodeAttribute("Dataverse Model Builder", "2.0.0.16")]
...
public partial class NewProcess : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
{
	...
	public const string EntityLogicalCollectionName = "newprocesses";
	
	public const string EntitySetName = "newprocesses";
	...
	public virtual newprocess_statecode? StateCode
	{
		get
		{
			return ((newprocess_statecode?)(EntityOptionSetEnum.GetEnum(this, "statecode")));
		}
		set
		{
	...
	public virtual newprocess_statuscode? StatusCode
	{
		get
		{
	...
	public System.Collections.Generic.IEnumerable<WorkflowLog> lk_newprocess_workflowlogs
	{
		get
		{
			return this.GetRelatedEntities<WorkflowLog>("lk_newprocess_workflowlogs", null);
		}
		set
		{
			this.OnPropertyChanging("lk_newprocess_workflowlogs");
			this.SetRelatedEntities<WorkflowLog>("lk_newprocess_workflowlogs", null, value);
	...
	public System.Collections.Generic.IEnumerable<ProcessSession> NewProcess_ProcessSessions
	{
		get
		{
			return this.GetRelatedEntities<ProcessSession>("NewProcess_ProcessSessions", null);
		}
		set
		{
			this.OnPropertyChanging("NewProcess_ProcessSessions");
			this.SetRelatedEntities<ProcessSession>("NewProcess_ProcessSessions", null, value);
	...
	public System.Collections.Generic.IEnumerable<SyncError> NewProcess_SyncErrors
	{
		get
		{
			return this.GetRelatedEntities<SyncError>("NewProcess_SyncErrors", null);
		}
		set
		{
			this.OnPropertyChanging("NewProcess_SyncErrors");
			this.SetRelatedEntities<SyncError>("NewProcess_SyncErrors", null, value);
	...
	public ProcessStage lk_newprocess_activestageid
	{
		get
		{
			return this.GetRelatedEntity<ProcessStage>("lk_newprocess_activestageid", null);
		}
		set
		{
			this.OnPropertyChanging("lk_newprocess_activestageid");
			this.SetRelatedEntity<ProcessStage>("lk_newprocess_activestageid", null, value);
	...
	public SystemUser lk_newprocess_createdby
	{
		get
		{
			return this.GetRelatedEntity<SystemUser>("lk_newprocess_createdby", null);
		}
	}
	...
	public SystemUser lk_newprocess_createdonbehalfby
	{
		get
		{
			return this.GetRelatedEntity<SystemUser>("lk_newprocess_createdonbehalfby", null);
		}
	}
	...
	public KnowledgeArticle lk_newprocess_knowledgearticleid
	{
		get
		{
			return this.GetRelatedEntity<KnowledgeArticle>("lk_newprocess_knowledgearticleid", null);
		}
		set
		{
			this.OnPropertyChanging("lk_newprocess_knowledgearticleid");
			this.SetRelatedEntity<KnowledgeArticle>("lk_newprocess_knowledgearticleid", null, value);
	...
	public SystemUser lk_newprocess_modifiedby
	{
		get
		{
			return this.GetRelatedEntity<SystemUser>("lk_newprocess_modifiedby", null);
		}
	}
	...
	public SystemUser lk_newprocess_modifiedonbehalfby
	{
		get
		{
			return this.GetRelatedEntity<SystemUser>("lk_newprocess_modifiedonbehalfby", null);
		}
	}
	...
	public Workflow lk_newprocess_processid
	{
		get
		{
			return this.GetRelatedEntity<Workflow>("lk_newprocess_processid", null);
		}
		set
		{
			this.OnPropertyChanging("lk_newprocess_processid");
			this.SetRelatedEntity<Workflow>("lk_newprocess_processid", null, value);
	...
	public Organization organization_newprocess
	{
		get
		{
			return this.GetRelatedEntity<Organization>("organization_newprocess", null);
		}
	}
	...
	public TransactionCurrency transactioncurrency_newprocess
	{
		get
		{
			return this.GetRelatedEntity<TransactionCurrency>("transactioncurrency_newprocess", null);
		}
		set
		{
			this.OnPropertyChanging("transactioncurrency_newprocess");
			this.SetRelatedEntity<TransactionCurrency>("transactioncurrency_newprocess", null, value);
