...
/// <summary>
/// Reason for the status of the expiredprocess.
/// </summary>
[System.Runtime.Serialization.DataContractAttribute()]
[System.CodeDom.Compiler.GeneratedCodeAttribute("Dataverse Model Builder", "2.0.0.16")]
...
public partial class ExpiredProcess : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
{
	...
	public System.Collections.Generic.IEnumerable<ProcessSession> ExpiredProcess_ProcessSessions
	{
		get
		{
			return this.GetRelatedEntities<ProcessSession>("ExpiredProcess_ProcessSessions", null);
		}
		set
		{
			this.OnPropertyChanging("ExpiredProcess_ProcessSessions");
			this.SetRelatedEntities<ProcessSession>("ExpiredProcess_ProcessSessions", null, value);
	...
	public System.Collections.Generic.IEnumerable<SyncError> ExpiredProcess_SyncErrors
	{
		get
		{
			return this.GetRelatedEntities<SyncError>("ExpiredProcess_SyncErrors", null);
		}
		set
		{
			this.OnPropertyChanging("ExpiredProcess_SyncErrors");
			this.SetRelatedEntities<SyncError>("ExpiredProcess_SyncErrors", null, value);
	...
	public System.Collections.Generic.IEnumerable<WorkflowLog> lk_expiredprocess_workflowlogs
	{
		get
		{
			return this.GetRelatedEntities<WorkflowLog>("lk_expiredprocess_workflowlogs", null);
		}
		set
		{
			this.OnPropertyChanging("lk_expiredprocess_workflowlogs");
			this.SetRelatedEntities<WorkflowLog>("lk_expiredprocess_workflowlogs", null, value);
	...
	public ProcessStage lk_expiredprocess_activestageid
	{
		get
		{
			return this.GetRelatedEntity<ProcessStage>("lk_expiredprocess_activestageid", null);
		}
		set
		{
			this.OnPropertyChanging("lk_expiredprocess_activestageid");
			this.SetRelatedEntity<ProcessStage>("lk_expiredprocess_activestageid", null, value);
	...
	public SystemUser lk_expiredprocess_createdby
	{
		get
		{
			return this.GetRelatedEntity<SystemUser>("lk_expiredprocess_createdby", null);
		}
	}
	...
	public SystemUser lk_expiredprocess_createdonbehalfby
	{
		get
		{
			return this.GetRelatedEntity<SystemUser>("lk_expiredprocess_createdonbehalfby", null);
		}
	}
	...
	public KnowledgeArticle lk_expiredprocess_knowledgearticleid
	{
		get
		{
			return this.GetRelatedEntity<KnowledgeArticle>("lk_expiredprocess_knowledgearticleid", null);
		}
		set
		{
			this.OnPropertyChanging("lk_expiredprocess_knowledgearticleid");
			this.SetRelatedEntity<KnowledgeArticle>("lk_expiredprocess_knowledgearticleid", null, value);
	...
	public SystemUser lk_expiredprocess_modifiedby
	{
		get
		{
			return this.GetRelatedEntity<SystemUser>("lk_expiredprocess_modifiedby", null);
		}
	}
	...
	public SystemUser lk_expiredprocess_modifiedonbehalfby
	{
		get
		{
			return this.GetRelatedEntity<SystemUser>("lk_expiredprocess_modifiedonbehalfby", null);
		}
	}
	...
	public Workflow lk_expiredprocess_processid
	{
		get
		{
			return this.GetRelatedEntity<Workflow>("lk_expiredprocess_processid", null);
		}
		set
		{
			this.OnPropertyChanging("lk_expiredprocess_processid");
			this.SetRelatedEntity<Workflow>("lk_expiredprocess_processid", null, value);
	...
	public Organization organization_expiredprocess
	{
		get
		{
			return this.GetRelatedEntity<Organization>("organization_expiredprocess", null);
		}
	}
	...
	public TransactionCurrency transactioncurrency_expiredprocess
	{
		get
		{
			return this.GetRelatedEntity<TransactionCurrency>("transactioncurrency_expiredprocess", null);
		}
		set
		{
			this.OnPropertyChanging("transactioncurrency_expiredprocess");
			this.SetRelatedEntity<TransactionCurrency>("transactioncurrency_expiredprocess", null, value);
